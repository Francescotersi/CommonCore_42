...
/*   Updated: 2025/07/30 16:14:19 by mfanelli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	info_checker(char *str, int mem[6])
{
	size_t	i;
	...
	if (str[0] == '\n' || str[i] == '\n')
		return (1);
	if (str[0] == '1' || str[1] == '1' || str[ft_strlen(str) - 2] == '1' || \
		(str[i] == '1') || (i <= (ft_strlen(str) - 1) && str[i + 1] == '1'))
		return (2);
